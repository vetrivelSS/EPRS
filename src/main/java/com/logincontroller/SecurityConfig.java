    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**","/api/business-partner/**","/api/work-order/**","/api/joborders/**","/api/production/**","/api/delivery-challan/**").permitAll() // Login & Register-ku permission kudukkurom
